...
const navByService: Record<Service, { href: string; label: string; icon: string }[]> = {
  tickets: [
    ...
    { href: "/admin/agent-booked", label: "Agent-Booked Passengers", icon: "🎫" },
    { href: "/admin/pricing", label: "Pricing & Commission", icon: "⚙️" },
    { href: "/admin/pricing/freight", label: "Freight Pricing", icon: "📦" },
    { href: "/admin/pricing/extra-luggage", label: "Extra Luggage Pricing", icon: "🧳" },
    { href: "/admin/pricing/shuttle", label: "Shuttle Pricing", icon: "🚐" },
    { href: "/admin/pricing/cab", label: "Cab Pricing", icon: "🚕" },
    { href: "/admin/shuttle-operators", label: "Shuttle Operators", icon: "🚐" },
    { href: "/admin/cab-operators", label: "Cab Operators", icon: "🚕" },
