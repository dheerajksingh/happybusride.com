...
const AUTH_PATHS = ["/cab/login", "/cab/register"];

const NAV = [
  { href: "/cab/dashboard", label: "Dashboard", icon: "📊" },
  { href: "/cab/bookings",  label: "Bookings",  icon: "📋" },
];
    ...
    <div className="flex h-screen overflow-hidden bg-gray-50">
      <aside className="flex h-screen w-56 flex-col border-r border-gray-200 bg-white">
        <div className="border-b border-gray-200 px-5 py-4">
          <Link href="/" className="text-base font-black text-orange-600">HappyBusRide</Link>
          <p className="text-xs text-gray-500">Cab Operator</p>
        </div>
        ...
        <div className="border-t border-gray-200 px-3 py-4">
          <button onClick={() => signOut({ callbackUrl: "/cab/login" })}
